...
namespace Orleans.Serialization
{
    internal static class BinaryTokenStreamWriterExtensions
    {
        ...
        public static void WriteTypeHeader(this BinaryTokenStreamWriterV2 @this, Type t, Type expected = null)
        {
            if (t == expected)
            {
        ...
        public static bool TryWriteSimpleObject(this BinaryTokenStreamWriterV2 @this, object obj)
        {
            if (obj == null)
            {
                @this.WriteNull();
