...
namespace Orleans.Serialization
{
    ...
    public ref struct BinaryTokenStreamWriterV2
    {
        ...
        public BinaryTokenStreamWriterV2(IBufferWriter<byte> output)
        {
            this._buffered = 0;
            this.Context = null;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public BinaryTokenStreamWriterV2(ISerializationContext context)
        {
            this._buffered = 0;
        ...
        {
            if (Context != null)
                this.Context.CurrentOffset += count;
